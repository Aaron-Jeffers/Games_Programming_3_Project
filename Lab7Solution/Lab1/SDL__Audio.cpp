...
void SDL__Audio::addSoundEffect(const char* path)
{
...
void SDL__Audio::addAudioTrack(const char* path)
{
...
void SDL__Audio::playSoundEffect(const int which) const
{
